...
{
    public static class CreateCharacterSelectScene
    {
        ...
        [MenuItem("Tools/Tidepool/Create Character Select Scene")]
        public static void CreateScene()
        {
            ...
            Text titleText = CreateText("TitleText", safeArea, "Pick who to walk as", 36, TextAnchor.MiddleCenter, new Vector2(0f, 280f), new Vector2(600f, 72f));
            ...
            CharacterSelectController controller = safeArea.gameObject.AddComponent<CharacterSelectController>();
