...
As of 2026-09-02, the repository includes a small CC0 prototype tile/UI subset, a small original procedural audio set, one original app icon, 13 AI-generated creature sprites, an AI-generated journal UI art set, one AI-generated mentor NPC sprite, and a small original procedural UI/tile art set (rounded panel sprite, 3 contest move icons, kelp and rocky-shelf tile art). No video or font assets are committed.
...
| `Assets/Art/Characters/mentor-barnacle-bill.png` | Mentor NPC sprite | AI-generated externally by Ryan (Google Gemini); background matte removed and reframed locally with Pillow (flood-fill background removal, tight crop, centered on a padded square canvas, resized) | Tidepool project AI-generated asset | Google Gemini image generation, local Pillow-based background removal and resize | 2026-09-02 | Selected concept from the Mentor NPC Prompt Log below (Barnacle Bill: an old barnacle-speckled lobster guide with one larger waving claw and a kelp satchel). Final PNG is 512x512 transparent, matching the creature sprite framing convention. | Yes - reviewed for accidental resemblance to protected characters (none found; original friendly lobster design, no copied franchise trade dress) and concept compliance. |
| `Assets/Art/UI/rounded_panel.png` | 9-sliceable rounded UI panel sprite | Original procedural drawing generated in-repo | Original Tidepool project asset | `scripts/generate-ui-panel-sprite.py`, Pillow (supersampled `rounded_rectangle`, downsampled) | 2026-09-02 | Single tintable white rounded rectangle (128x128, 28px corner radius, 32px 9-slice border) used as the shared background for buttons and panels across every generated scene. No external image input. | Yes - reviewed for protected visual trade dress; a plain geometric shape, no copied UI kit or iconography. |
| `Assets/Art/UI/ContestIcons/attack.png` | Contest move category icon (droplet) | Original procedural drawing generated in-repo | Original Tidepool project asset | `scripts/generate-contest-move-icons.py`, Pillow | 2026-09-02 | White droplet glyph (64x64, transparent) tinted per-category at runtime; replaces the "!" text placeholder. No external image input. | Yes - reviewed for protected visual trade dress; a generic droplet shape. |
| `Assets/Art/UI/ContestIcons/focus.png` | Contest move category icon (starburst) | Original procedural drawing generated in-repo | Original Tidepool project asset | `scripts/generate-contest-move-icons.py`, Pillow | 2026-09-02 | White 4-point starburst glyph (64x64, transparent); replaces the "@" text placeholder. No external image input. | Yes - reviewed for protected visual trade dress; a generic sparkle shape. |
| `Assets/Art/UI/ContestIcons/defend.png` | Contest move category icon (shield) | Original procedural drawing generated in-repo | Original Tidepool project asset | `scripts/generate-contest-move-icons.py`, Pillow | 2026-09-02 | White shield glyph (64x64, transparent); replaces the "[]" text placeholder. No external image input. | Yes - reviewed for protected visual trade dress; a generic shield shape, no copied heraldry or franchise iconography. |
| `Assets/Art/Tiles/KenneyRpgBase/kelp_tall.png` | Kelp Curtain zone tile/obstacle sprite | Original procedural drawing generated in-repo | Original Tidepool project asset | `scripts/generate-kelp-rock-tiles.py`, Pillow | 2026-09-02 | Tall wavy kelp frond cluster (64x64, transparent), matching the existing Kenney-style obstacle sprite convention (soft silhouette, darker accent dots). Replaces a prior workaround that retinted the unrelated `grass_tufts` sprite. No external image input. | Yes - reviewed for protected visual trade dress; a generic plant silhouette consistent with the rest of the tile set. |
| `Assets/Art/Tiles/KenneyRpgBase/rock_mossy.png` | Rocky Shelf zone tile/obstacle sprite | Original procedural drawing generated in-repo | Original Tidepool project asset | `scripts/generate-kelp-rock-tiles.py`, Pillow | 2026-09-02 | Angular gray boulder cluster with moss accent dots (64x64, transparent), matching the existing Kenney-style obstacle sprite convention. Replaces a prior workaround that retinted the unrelated `shrub_light` sprite. No external image input. | Yes - reviewed for protected visual trade dress; a generic rock silhouette consistent with the rest of the tile set. |
...
| `Assets/Art/Characters/mentor-barnacle-bill.png` | Barnacle Bill | Mentor NPC sprite — **selected and committed** | Google Gemini image generation (generated externally by Ryan) | 2026-09-02 | Original proposed prompt (2026-08-24): `Use case: illustration-story Asset type: Tidepool game mentor NPC sprite Primary request: Children's book illustration of a friendly tidepool guide character, soft watercolor and ink style, warm daylight, gentle rounded shapes, front three-quarter view, centered, full body. An old barnacle-speckled lobster guide with one larger waving claw, rounded friendly features, warm eyes, a small kelp satchel for notes, coral and stone gray shell colors, affectionate and welcoming, not scary. Scene/backdrop: perfectly flat solid #ff00ff chroma-key background for background removal. Composition/framing: single character only, centered, full body, generous padding, character fills about 80% of the frame. Lighting/mood: warm daylight, calm, curious, and welcoming. Constraints: no text, no border, no watermark, no cast shadow, no contact shadow, no reflection. Background must be one uniform #ff00ff color with no gradients, shadows, texture, floor plane, or lighting variation. Do not use #ff00ff anywhere in the character. Avoid protected franchise references, existing character resemblance, red/white capture-device imagery, and living artist styles.` The committed sprite was generated externally by Ryan via Google Gemini rather than run through this exact prompt string; the final art matches the concept (old barnacle-speckled lobster, one larger waving claw, kelp/canvas satchel, coral and stone-gray coloring, warm and welcoming). | Selected 2026-09-02. See Current Committed Asset Inventory above for the committed sprite's review notes. |
...
- 2026-09-02: Reviewed the committed mentor NPC sprite (Barnacle Bill, `Assets/Art/Characters/mentor-barnacle-bill.png`). It is an original friendly cartoon lobster/crustacean design (one larger waving claw, kelp/canvas satchel, coral and stone-gray coloring) in the same children's-book watercolor style as the creature sprites; no text, no protected capture-device trade dress, and no resemblance to any known protected franchise character. Approved.
- 2026-09-02: Reviewed the procedural UI/tile art set (`rounded_panel.png`, the three `ContestIcons/*.png` glyphs, and `kelp_tall.png`/`rock_mossy.png`). All are simple original geometric shapes generated with Pillow scripts, no external image input, no text, no protected visual trade dress, and no resemblance to any copied UI kit, franchise iconography, or existing character design. Approved.
